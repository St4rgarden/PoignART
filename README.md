...
🔏 Edit your smart contract `PoignART.sol` in `packages/hardhat/contracts`
...
📚 Go through each topic from [solidity by example](https://solidity-by-example.org) editing `PoignART.sol` in **🏗 scaffold-eth**
